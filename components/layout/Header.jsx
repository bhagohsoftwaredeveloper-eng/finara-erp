    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6 gap-4 sticky top-0 z-20 dark:bg-gray-900 dark:border-gray-800">
      ...
      <div className="relative hidden md:block">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 bg-gray-100 border-0 rounded-lg text-sm w-56 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all dark:bg-gray-800 dark:text-gray-100 dark:focus:bg-gray-700"
        />
      </div>
